...
rule all:
    input:
        ...
        # ----- ClinVar SVs
        f"output/full/tracks/track-strucvars-clinvar-grch37-{DV.clinvar_version}+{DV.tracks}/clinvar_strucvars.bin",
        f"output/full/tracks/track-strucvars-clinvar-grch38-{DV.clinvar_version}+{DV.tracks}/clinvar_strucvars.bin",
