...
def generate_input_files():
    ...
    if "grch38" in genomebuilds:
        input_files += [
            ...
            expand(
                "work/download/annos/grch38/seqvars/gnomad_{eg}/{v}/gnomad.{eg}.v{v}.sites.chr{c}.vcf.bgz{i}",
                v=DV.gnomad_v4,
                eg=["exomes", "genomes"],
                c=CHROMS,
                i=[".tbi", ""],
    ...
    if "grch37" in genomebuilds:
        input_files += [
            ...
            expand(
                "work/download/annos/grch37/seqvars/gnomad_{eg}/{v}/gnomad.{eg}.v{v}.sites.chr{c}.vcf.bgz{i}",
                v=DV.gnomad_v2,
                eg=["exomes", "genomes"],
                c=CHROMS,
                i=[".tbi", ""],
