...
rule features_ucsc_genomic_super_dups_process:  # -- processing of UCSC genomicSuperDups
    ...
    output:
        bed="work/annos/{genome_release}/features/ucsc/{version}/genomicSuperDups.bed.gz",
        bed_md5="work/annos/{genome_release}/features/ucsc/{version}/genomicSuperDups.bed.gz.md5",
        bed_tbi="work/annos/{genome_release}/features/ucsc/{version}/genomicSuperDups.bed.gz.tbi",
        bed_tbi_md5="work/annos/{genome_release}/features/ucsc/{version}/genomicSuperDups.bed.gz.tbi.md5",
    shell:
        r"""
        (
...
rule features_ucsc_rmsk_process:  # -- processing of UCSC rmsk
    ...
    output:
        bed="work/annos/{genome_release}/features/ucsc/{version}/rmsk.bed.gz",
        bed_md5="work/annos/{genome_release}/features/ucsc/{version}/rmsk.bed.gz.md5",
        bed_tbi="work/annos/{genome_release}/features/ucsc/{version}/rmsk.bed.gz.tbi",
        bed_tbi_md5="work/annos/{genome_release}/features/ucsc/{version}/rmsk.bed.gz.tbi.md5",
    shell:
        r"""
        (
            echo -e "#chrom\tbegin\tend\tlabel"
...
rule features_ucsc_liftover_process:  # -- process of UCSC *SeqLiftOverPsl
    ...
    output:
        bed="work/annos/{genome_release}/features/ucsc/{version}/{prefix}SeqLiftOverPsl.bed.gz",
        bed_md5="work/annos/{genome_release}/features/ucsc/{version}/{prefix}SeqLiftOverPsl.bed.gz.md5",
        bed_tbi="work/annos/{genome_release}/features/ucsc/{version}/{prefix}SeqLiftOverPsl.bed.gz.tbi",
        bed_tbi_md5="work/annos/{genome_release}/features/ucsc/{version}/{prefix}SeqLiftOverPsl.bed.gz.tbi.md5",
    shell:
        r"""
        (
            echo -e "#chrom\tbegin\tend\tlabel"
