...
rule annos_strucvars_dgv_process:  # -- download DGV files
    ...
    output:
        bed="output/worker/annos/strucvars/dgv-{genome_release}-{version}/dgv.bed.gz",
        bed_md5="output/worker/annos/strucvars/dgv-{genome_release}-{version}/dgv.bed.gz.md5",
        bed_tbi="output/worker/annos/strucvars/dgv-{genome_release}-{version}/dgv.bed.gz.tbi",
        bed_tbi_md5="output/worker/annos/strucvars/dgv-{genome_release}-{version}/dgv.bed.gz.tbi.md5",
    shell:
        r"""
        awk \
            -F $'\t' \
...
rule annos_strucvars_dgv_gs_process:  # -- download DGV GS files
    ...
    output:
        bed="output/worker/annos/strucvars/dgv-gs-{genome_release}-{version}/dgv-gs.bed.gz",
        bed_md5="output/worker/annos/strucvars/dgv-gs-{genome_release}-{version}/dgv-gs.bed.gz.md5",
        bed_tbi="output/worker/annos/strucvars/dgv-gs-{genome_release}-{version}/dgv-gs.bed.gz.tbi",
        bed_tbi_md5="output/worker/annos/strucvars/dgv-gs-{genome_release}-{version}/dgv-gs.bed.gz.tbi.md5",
    shell:
        r"""
        awk \
            -F $'\t' \
