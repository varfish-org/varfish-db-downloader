...
rule annos_strucvars_exac_grch37_process:  # -- process ExAC-CNV files
    input:
        bed="work/download/annos/grch37/strucvars/exac/0.3.1/exac-final.autosome-1pct-sq60-qc-prot-coding.cnv.bed",
    output:
        bed="work/annos/grch37/strucvars/exac/0.3.1/exac.bed.gz",
        bed_md5="work/annos/grch37/strucvars/exac/0.3.1/exac.bed.gz.md5",
        bed_tbi="work/annos/grch37/strucvars/exac/0.3.1/exac.bed.gz.tbi",
        bed_tbi_md5="work/annos/grch37/strucvars/exac/0.3.1/exac.bed.gz.tbi.md5",
    shell:
        r"""
        awk \
