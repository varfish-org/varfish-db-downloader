...
rule genes_mehari_data_tx_copy:  # -- Copy data to output
    input:
        zstd="work/download/mehari-data-tx/{genome_release}-{version}/mehari-data-txs-{genome_release}-{version}.bin.zst",
    output:
        zstd="output/full/worker/genes-txs-{genome_release}-{version}/mehari-data-txs-{genome_release}-{version}.bin.zst",
        zstd_md5="output/full/worker/genes-txs-{genome_release}-{version}/mehari-data-txs-{genome_release}-{version}.bin.zst.md5",
    shell:
        r"""
