...
def input_result_grch37_release_server_db(wildcards):
    ...
    other = [
        ...
        "GRCh37/extra_annos/{release_name}/ExtraAnnoField.release_info",
        "GRCh37/extra_annos/{release_name}/ExtraAnno.release_info",
...
def input_result_grch38_release_server_db(wildcards):
    ...
    other = [
        ...
        "GRCh38/extra_annos/{release_name}/ExtraAnnoField.release_info",
        "GRCh38/extra_annos/{release_name}/ExtraAnno.release_info",
