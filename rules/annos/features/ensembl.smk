...
rule annos_features_ensembl_gene_regions_grch37_download:  # -- download ENSEMBL gene regions files
    output:
        gtf="work/download/annos/grch37/ensembl_genes/Homo_sapiens.GRCh37.87.gtf.gz",
    shell:
        r"""
...
rule annos_features_ensembl_gene_regions_grch37_process:  # -- process ENSEMBL gene regions files
    input:
        gtf="work/download/annos/grch37/ensembl_genes/Homo_sapiens.GRCh37.87.gtf.gz",
    output:
        tsv="work/annos/grch37/features/ensembl/ensembl_genes.bed.gz",
        tsv_md5="work/annos/grch37/features/ensembl/ensembl_genes.bed.gz.md5",
        tsv_tbi="work/annos/grch37/features/ensembl/ensembl_genes.bed.gz.tbi",
        tsv_tbi_md5="work/annos/grch37/features/ensembl/ensembl_genes.bed.gz.tbi.md5",
    shell:
        r"""
        awk \
            -F $'\t' \
