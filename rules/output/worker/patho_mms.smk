...
rule output_worker_patho_mms:
    output:
        bed="output/worker/patho-mms-{genome_release}-{v_patho_mms}/patho-mms.bed",
        bed_md5="output/worker/patho-mms-{genome_release}-{v_patho_mms}/patho-mms.bed.md5",
        spec="output/worker/patho-mms-{genome_release}-{v_patho_mms}/patho-smms.bed.spec.json",
