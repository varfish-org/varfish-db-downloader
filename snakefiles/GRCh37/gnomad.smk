    ...
    shell:
        r"""
                (
                    cat {input.header} | tr '\n' '\t' | sed -e 's/\t*$/\n/g';
                    bcftools query {input.vcf} \
                        -f "GRCh37\t%CHROM\t%POS\t%END\t\t%REF\t%ALT\t%AC\t%AC_afr\t%AC_amr\t%AC_asj\t%AC_eas\t%AC_fin\t%AC_nfe\t%AC_oth\t%AN\t%AN_afr\t%AN_amr\t%AN_asj\t%AN_eas\t%AN_fin\t%AN_nfe\t%AN_oth\t%AF\t%AF_afr\t%AF_amr\t%AF_asj\t%AF_eas\t%AF_fin\t%AF_nfe\t%AF_oth\t%AC_male\t%AC_afr_male\t%AC_amr_male\t%AC_asj_male\t%AC_eas_male\t%AC_fin_male\t%AC_nfe_male\t%AC_oth_male\t%nhomalt\t%nhomalt_afr\t%nhomalt_amr\t%nhomalt_asj\t%nhomalt_eas\t%nhomalt_fin\t%nhomalt_nfe\t%nhomalt_oth\t%popmax\t%AC_popmax\t%AN_popmax\t%AF_popmax\t.\t%nhomalt_popmax\t%controls_AC\t%controls_AC_afr\t%controls_AC_amr\t%controls_AC_asj\t%controls_AC_eas\t%controls_AC_fin\t%controls_AC_nfe\t%controls_AC_oth\t%controls_AF\t%controls_AF_afr\t%controls_AF_amr\t%controls_AF_asj\t%controls_AF_eas\t%controls_AF_fin\t%controls_AF_nfe\t%controls_AF_oth\t%controls_AN\t%controls_AN_afr\t%controls_AN_amr\t%controls_AN_asj\t%controls_AN_eas\t%controls_AN_fin\t%controls_AN_nfe\t%controls_AN_oth\t%controls_AC_male\t%controls_AC_afr_male\t%controls_AC_amr_male\t%controls_AC_asj_male\t%controls_AC_eas_male\t%controls_AC_fin_male\t%controls_AC_nfe_male\t%controls_AC_oth_male\t%controls_nhomalt\t%controls_nhomalt_afr\t%controls_nhomalt_amr\t%controls_nhomalt_asj\t%controls_nhomalt_eas\t%controls_nhomalt_fin\t%controls_nhomalt_nfe\t%controls_nhomalt_oth\t%controls_popmax\t%controls_AC_popmax\t%controls_AN_popmax\t%controls_AF_popmax\t.\t%controls_nhomalt_popmax\t%nonpar\n" \
                    | sort -t $'\t' -u -k 2,2 -k 3,3 -k 4,4 -k 6,6 -k 7,7 -S {config[sort_memory]} \
                    | awk -F $'\t' \
                        'BEGIN {{
                            OFS = FS
