        ...
        r"""
                (
                    ...
                    bcftools query {input.vcf} \
                        -f "GRCh38\t%CHROM\t%POS\t%END\t\t%REF\t%ALT\t%AC\t%AC_afr\t%AC_amr\t%AC_asj\t%AC_eas\t%AC_fin\t%AC_nfe\t%AC_oth\t%AC_sas\t%AN\t%AN_afr\t%AN_amr\t%AN_asj\t%AN_eas\t%AN_fin\t%AN_nfe\t%AN_oth\t%AN_sas\t%AF\t%AF_afr\t%AF_amr\t%AF_asj\t%AF_eas\t%AF_fin\t%AF_nfe\t%AF_oth\t%AF_sas\t%AC_XY\t%AC_afr_XY\t%AC_amr_XY\t%AC_asj_XY\t%AC_eas_XY\t%AC_fin_XY\t%AC_nfe_XY\t%AC_oth_XY\t%AC_sas_XY\t%nhomalt\t%nhomalt_afr\t%nhomalt_amr\t%nhomalt_asj\t%nhomalt_eas\t%nhomalt_fin\t%nhomalt_nfe\t%nhomalt_oth\t%nhomalt_sas\t%popmax\t%AC_popmax\t%AN_popmax\t%AF_popmax\t.\t%nhomalt_popmax\t%controls_AC\t%controls_AC_afr\t%controls_AC_amr\t%controls_AC_asj\t%controls_AC_eas\t%controls_AC_fin\t%controls_AC_nfe\t%controls_AC_oth\t%controls_AC_sas\t%controls_AF\t%controls_AF_afr\t%controls_AF_amr\t%controls_AF_asj\t%controls_AF_eas\t%controls_AF_fin\t%controls_AF_nfe\t%controls_AF_oth\t%controls_AF_sas\t%controls_AN\t%controls_AN_afr\t%controls_AN_amr\t%controls_AN_asj\t%controls_AN_eas\t%controls_AN_fin\t%controls_AN_nfe\t%controls_AN_oth\t%controls_AN_sas\t%controls_AC_XY\t%controls_AC_afr_XY\t%controls_AC_amr_XY\t%controls_AC_asj_XY\t%controls_AC_eas_XY\t%controls_AC_fin_XY\t%controls_AC_nfe_XY\t%controls_AC_oth_XY\t%controls_AC_sas_XY\t%controls_nhomalt\t%controls_nhomalt_afr\t%controls_nhomalt_amr\t%controls_nhomalt_asj\t%controls_nhomalt_eas\t%controls_nhomalt_fin\t%controls_nhomalt_nfe\t%controls_nhomalt_oth\t%controls_nhomalt_sas\t%controls_popmax\t%controls_AC_popmax\t%controls_AN_popmax\t%controls_AF_popmax\t.\t%controls_nhomalt_popmax\t%nonpar\n" \
