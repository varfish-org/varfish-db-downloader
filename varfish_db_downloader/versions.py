...
DATA_VERSIONS = DataVersions(
    ...
    ensembl_37_archive_url="https://grch37.ensembl.org",  # not possible to tag a specific version but according to them they didn't update essential parts since release 75 (2014)
    ...
    today=TODAY,
    dbnsfp="4.5",  # last accessible version, newer ones only via registration (academic) or commercial
    dbscsnv="1.1",
    cadd="1.6",
    ...
    dbsnp="b157",
    acmg_sf="3.3",  # ATTN! source file is placed manually in the data directory
    orphadata=TODAY,
    patho_mms="20220730",
